...
enum sbi_ext_nacc_fid {
    ...
    SBI_EXT_NACC_REGION_SYNC_BEGIN = 0xe,
    SBI_EXT_NACC_REGION_SYNC_RANGE = 0xf,
    SBI_EXT_NACC_REGION_SYNC_END = 0x10,
    SBI_EXT_NACC_STARTUP_COORD = 0x11,
    SBI_EXT_NACC_STARTUP_AUDIT_RANGE = 0x12,
